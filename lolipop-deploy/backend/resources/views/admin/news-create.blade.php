        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">ニュース記事作成</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="gamenews_title" name="gamenews_title" class="form-control" value="{{ old('gamenews_title') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="gamenews_content" name="gamenews_content" class="form-control" rows="10" required>{{ old('gamenews_content') }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" id="gamenews_is_published" name="gamenews_is_published" class="custom-control-input" value="1" {{ old('gamenews_is_published') ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="gamenews_publish_start_at" name="gamenews_publish_start_at" class="form-control" value="{{ old('gamenews_publish_start_at') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" id="gamenews_publish_end_at" name="gamenews_publish_end_at" class="form-control" value="{{ old('gamenews_publish_end_at') }}">
